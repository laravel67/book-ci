...
<div class="container my-5">
    <h1 class="border-bottom mb-4">Update Book</h1>
    <form class="mb-5" method="post" action="<?= base_url('/book/update/' . $book['id']); ?>" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="title" id="title" class="form-control <?= session('errors.title') ? 'is-invalid': '' ?>" value="<?= old('title', $book['title']) ?>" >
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="author" id="author" class="form-control <?= session('errors.author') ? 'is-invalid': '' ?>" value="<?= old('author', $book['author']) ?>" >
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="publisher" id="publisher" class="form-control <?= session('errors.publisher') ? 'is-invalid': '' ?>" value="<?= old('publisher', $book['publisher']) ?>" >
        ...
        <div class="form-group row py-0">
            ...
            <div class="col-sm-10">
                ...
                <div class="d-flex justify-content-center mx-auto p-0 m-0">
                    <?php if (isset($book['cover']) && $book['cover'] != 'default.jpg'): ?>
                        <img class="img-fluid" style="width: 100px;" src="<?= base_url('/img/' . $book['cover']); ?>" id="previewCover">
                    <?php else: ?>
